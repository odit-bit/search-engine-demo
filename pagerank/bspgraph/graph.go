...
import (
	...
	"github.com/odit-bit/se/pagerank/bspgraph/message"
)
...
func New(cfg GraphConfig) (*Graph, error) {
...
func (g *Graph) Reset() error {
	...
	g.vertices = map[string]*Vertex{}       //make(map[string]*Vertex)
	g.aggregators = map[string]Aggregator{} //make(map[string]Aggregator)
	return nil
}
