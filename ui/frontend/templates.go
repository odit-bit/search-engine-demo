...
<html>
  <head>
    <meta charset="UTF-8">
    <title>demo Seacrh-Engine</title>
    <style>
  ...
  <body>
    <header class="l">
      <span class="b">demo</span> <span class="r">-</span>
      <span class="r">Search Engine</span> 
    </header>
    <section class="tc">
      <form action="{{.searchEndpoint}}">
      <input class="t" type="text" name="q" placeholder="Enter search"/>
      <br>
...
<html>
  <head>
    <meta charset="UTF-8">
    <title>demo Seacrh-Engine{{.messageTitle}} </title>
    <style>
      .is{display:inline;}
  ...
  <body>
    <header>
      ...
      <section class="is">
      <form action="{{.searchEndpoint}}">
        <input class="t" type="text" name="q" placeholder="Enter search ex: github" value="{{.searchTerms}}"/>
        <input class="sb" type="submit" value="Search"/>
      </form>
      </section>
    </header>
...
<html>
  <head>
    <meta charset="UTF-8">
    <title>demo Seacrh-Engine | Search</title>
    <style>
      .is{display:inline;}
      .l{font-size:2em;font-weight:bold;text-shadow: 1px 1px 1px rgba(0,0,0,0.4);}
			.l a{text-decoration: none;}
...
<html>
  <head>
    <meta charset="UTF-8">
    <title>demo Seacrh-Engine | Submit site</title>
    <style>
      .l{font-size:3em;font-weight:bold;text-align:center;text-shadow: 1px 1px 1px rgba(0,0,0,0.4);}
      .l a{text-decoration: none;}
      .r{color:red;}
